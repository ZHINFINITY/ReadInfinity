...
Native open-with and file-picker flows therefore provide direct device-file access. Folder scanning and watched-folder behavior remain local. Browser builds cannot retain unrestricted arbitrary filesystem paths: the browser must use its own user-selected file mechanism and browser storage constraints.
